      ...
      <View style={{flex: 1}}>
        <Router style={{flex: 1}}>
          ...
          >
            ...
            <Scene key={'dashBoard'} title={'IPL Selection'} component={DashBoardConatiner} type={ActionConst.RESET} initial />
            <Scene key={'viewTask'} title={'Player details'} component={ViewTask} />
